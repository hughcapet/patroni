...
def set_fault_point(context, fault_name, fault_type=FAULT_TYPES.EXCEPTION, start_from=1, end_after=0):
...
def set_fault_point_sleep(context, fault_name, sleep_time, start_from=1, end_after=0):
    data = {'fault_name': fault_name,
